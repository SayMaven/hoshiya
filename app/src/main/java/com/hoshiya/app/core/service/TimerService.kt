package com.hoshiya.app.core.service
...
import com.hoshiya.app.HoshiyaApplication
import com.hoshiya.app.MainActivity
import com.hoshiya.app.R
...
class TimerService : Service() {
    ...
    private fun buildNotification(): Notification {
        ...
        val builder = NotificationCompat.Builder(this, HoshiyaApplication.TIMER_CHANNEL_ID)
            .setContentTitle("$timeString • $modeTitle (星夜)")
    ...
    companion object {
        const val ACTION_START = "com.hoshiya.action.START"
        const val ACTION_PAUSE = "com.hoshiya.action.PAUSE"
        const val ACTION_RESUME = "com.hoshiya.action.RESUME"
        const val ACTION_RESET = "com.hoshiya.action.RESET"
        const val ACTION_SKIP = "com.hoshiya.action.SKIP"
        const val ACTION_STOP_SERVICE = "com.hoshiya.action.STOP_SERVICE"
    }
}
